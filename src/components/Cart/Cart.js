...
export default class Cart extends Component {
  ...
  calculateTotalAmount = (cart) => {
    return cart.reduce((a, v) => {
      const selectedCurrencyPrice = this.findSelectedCurrencyPrice(
        v,
        this.props.currency
      );
      ...
      <div className={s[`${type}Cart`]}>
                ...
                {item.attributes && (
                  <AttributesButtons
                    ...
                    changeSelectedAttributes={
                      this.props.changeSelectedAttributes
                    }
        ...
        {type === "dropdown" && cart.length !== 0 && (
          <div className={s.buttonsWrapper}>
            <Link className={s.link} to="/cart" onClick={this.onLinkClick}>
              View bag
            </Link>
